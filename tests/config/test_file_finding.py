...
from opsbox.config import find_config_file

# ruff: noqa: S101


# region find_config
@patch("opsbox.config.path.isfile", return_value=True)
@patch("opsbox.config.path.expanduser", return_value="/mock/home")
...
@patch("opsbox.config.path.isfile", return_value=False)
@patch("opsbox.config.path.expanduser", return_value="/mock/home")
